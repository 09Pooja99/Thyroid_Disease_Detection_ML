...
import os
import sys
from thyroid_detection.util.util import read_yaml_file, write_yaml_file, load_object, load_npz_data
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            train_dataframe = load_npz_data(file_path=train_file_path,
                                                           schema_file_path=schema_file_path,
                                                           )
            test_dataframe = load_npz_data(file_path=test_file_path,
                                                          schema_file_path=schema_file_path,
                                                          )
